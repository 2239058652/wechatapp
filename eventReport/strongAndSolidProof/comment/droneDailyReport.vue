		...
		<view class="report-viewarea">
			<view class="form">
				<u-form :model="dataTemp" ref="uForm" label-width="170" :error-type="errorType">
					...
					<u-form-item label="巡逻时长:" :required="true" prop="patrolDuration">
						<u-number-box v-model="dataTemp.patrolDuration" 
							:min="1" :max="10000" :input-width="250"
							:step="1" :input-height="70">
						</u-number-box> <text style="margin-left: 5%;">分钟</text>
					</u-form-item>
				</u-form>
			</view>
			<view class="form">
				<u-divider>无人机巡逻情况</u-divider>
			...
			saveData() {
				...
				this.$refs.uForm.validate(valid => {
					...
					if (valid) {
						...
						StrongAndSolidProof.addDronePatrolLogReport(this.dataTemp).then(res => {
