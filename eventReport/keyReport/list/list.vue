<template>
	<view class="content">
		<view class="toppicker">
			<view style="width: 40%;padding: 10rpx 50rpx 0 0;">
				<u-input type="select" :select-open="reportTypeShow" input-align="center" v-model="typeText" :border="false"
				 placeholder="举报类型" @click="reportTypeShow = true" />
				<u-picker mode="selector" range-key="label" :range="reportTypeList" v-model="reportTypeShow" @confirm="reportTypeChange"></u-picker>
			</view>
			<view class="select_text">|</view>
			<view style="width: 40%;padding: 10rpx 100rpx 0 0;">
				<u-input type="select" :select-open="reportObjectShow" input-align="center" v-model="reportObjectText" :border="false"
				 placeholder="举报对象所属组织" @click="reportObjectShow = true" />
				<u-picker mode="selector" range-key="label" :range="reportObjectList" v-model="reportObjectShow" @confirm="reportObjectChange"></u-picker>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			fetchList() {
				...
				KeyReportApi.getKeyReportList(_this.query).then(res => {
					if (res.data.code == 0) {
