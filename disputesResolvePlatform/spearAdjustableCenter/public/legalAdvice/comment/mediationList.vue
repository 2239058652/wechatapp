			...
			<u-card :show-head="false" style="margin-bottom: 2vh;">
				<view class="content" slot="body">
					...
					<view style="margin-top: 1vh;text-align: right;">
						<view style="margin-top: 1vh;text-align: right;">
							<u-button size="mini" style="height: 65rpx;" @click="handleView(item)">回复详情</u-button>
							<u-button type="primary" size="mini" style="margin-left: 5%;height: 65rpx;" @click="evaluation(item)">立即评价</u-button>
						</view>
					</view>
				</view>
			</u-card>
...
<script>
	...
	export default {
		...
		methods: {
			...
			confirmCancle() {
				var _self = this
				LegalAdvice.evaluateMediateAdvisory({
					advisoryId: _self.evaluationId,
