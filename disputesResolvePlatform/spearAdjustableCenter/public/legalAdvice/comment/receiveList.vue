<template>
	<view class="content">
			...
			<u-card :show-head="false" style="margin-bottom: 2vh;">
				<view class="content" slot="body">
					...
					<view style="margin-top: 1vh;text-align: right;">
						<u-button size="mini" style="height: 65rpx;" @click="handleView(item)">咨询信息</u-button>
						<!-- <u-button type="info" size="mini" style="margin-left: 5%;height: 65rpx;" @click="cancelConsulting(item)">取消咨询</u-button> -->
					</view>
				</view>
			</u-card>
		</view>
		<u-modal v-model="cancelShow" :show-cancel-button="true" content="是否确定取消这一法律服务咨询？"></u-modal>
		<view v-if="showList.length == 0" class="text-center justify-center flex flex-wrap padding align-center nodata" style="background-color: #FFFFFF;height: 100vh;">
			<u-empty text="还没有待回复的法律服务问题咨询记录..." mode="data"></u-empty>
		</view>
	</view>
</template>
